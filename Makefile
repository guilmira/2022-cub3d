...
#    Updated: 2022/08/11 14:48:52 by guilmira         ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
NAME		= cube
CC			= gcc
CFLAGS		= -Wall -Wextra -O3 #-fsanitize=address   -g3#-Werror 
ARG			= easy_map2.cub
#ARG		= default.cub
...
FOLDER2		= $(addprefix $(ROUTE)/2vector_control/,		vectors.c  vector_tools.c vector_arithmetic.c vector_arith_advanced.c 2Dcast_beam.c 2Dcast_ray.c 2Dinit_ray.c ray_collision.c ray_collision2.c)
